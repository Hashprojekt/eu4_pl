...
function findColorByBrightness(rgbColor,brightness){
	...
	*/
	...
	var activeSmallSquareColor = ['#F7DB77']; // Color of small square at the left of each menu item - only one item in the array if you only have one color
	var colorSquareWidth = 5; 	// Width of small square;
	var marginSquare = 3;
