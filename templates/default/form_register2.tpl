...
<b>Zdjêcie do galerii nr. 1:</b>(Dozwolone rozszerzenia: jpg, jpeg, gif, png)<br>
<input type="file" name="file3" size="40" class="file"><br>
<b>Opis do zdjêcia pierwszego:</b><br>
<textarea name="opis1" rows="10"></textarea><br>
<b>Zdjêcie do galerii nr. 2:</b>(Dozwolone rozszerzenia: jpg, jpeg, gif, png)<br>
<input type="file" name="file4" size="40" class="file"><br>
<b>Opis do zdjêcia drugiego:</b><br>
<textarea name="opis2" rows="10"></textarea><br>
<b>Zdjêcie do galerii nr. 3:</b>(Dozwolone rozszerzenia: jpg, jpeg, gif, png)<br>
<input type="file" name="file5" size="40" class="file"><br>
<b>Opis do zdjêcia trzeciego:</b><br>
<textarea name="opis3" rows="10"></textarea><br>
<b>Zdjêcie do galerii nr. 4:</b>(Dozwolone rozszerzenia: jpg, jpeg, gif, png)<br>
<input type="file" name="file6" size="40" class="file"><br>
<b>Opis do zdjêcia czwartego:</b><br>
